...
abline(v = c(LL95, UL95), lty = 2, lwd = 1.5)

abline(v = c(LL99, UL99), lty = 3, lwd = 1.5)

points(x = plantMinLogLik$minimum, y = plantMinLogLik$objective, pch = 21, bg = "cornflowerblue")
