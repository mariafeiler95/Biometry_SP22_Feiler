...
> The standard error is a measure of how accurate of a representation the mean of a sample from a given population if the true population mean; the larger the standard error, the less likely your sample is representative of the true population (in mean). 
