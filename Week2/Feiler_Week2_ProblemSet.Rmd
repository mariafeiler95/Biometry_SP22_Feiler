...
First, I need to determine the best number of bootstraps. I did this by testing 1000, 10000, 100000, 1000000, and 10000000 iterations.


```{r bootstrap test 1000, echo = FALSE, cache = TRUE}
...
# Log the difference between the standard error of the bootstrap
diff <- c()

diff[1] <- (find.st.err(bootT, nit) - find.st.err(bootC, nit)) - sqrt(abs(var(treatment)/length(treatment)-var(control)/length(control)))

```

```{r bootstrap test 10000, echo = FALSE, cache = TRUE}
# Define number of iterations
nit <- 10000
...
diff[2] <- (find.st.err(bootT, nit) - find.st.err(bootC, nit)) - sqrt(abs(var(treatment)/length(treatment)-var(control)/length(control)))

```

```{r bootstrap test 100000, echo = FALSE, cache = TRUE}
# Define number of iterations
nit <- 100000
...
diff[3] <- (find.st.err(bootT, nit) - find.st.err(bootC, nit)) - sqrt(abs(var(treatment)/length(treatment)-var(control)/length(control)))

```

```{r bootstrap test 1000000, echo = FALSE, cache = TRUE}
# Define number of iterations
nit <- 1000000
...
diff[4] <- (find.st.err(bootT, nit) - find.st.err(bootC, nit)) - sqrt(abs(var(treatment)/length(treatment)-var(control)/length(control)))

```

```{r bootstrap test 10000000, echo = FALSE, cache = TRUE}
...
diff[5] <- (find.st.err(bootT, nit) - find.st.err(bootC, nit)) - sqrt(abs(var(treatment)/length(treatment)-var(control)/length(control)))
