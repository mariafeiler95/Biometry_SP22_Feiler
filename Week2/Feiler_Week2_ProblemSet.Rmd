...
For questions 2a and 2b, I will define a function for computing the standard error of my bootstrap samples. 
...
upper <- mean(bootDiff)+1.96*sterr_diff
lower <- mean(bootDiff)-1.96*sterr_diff

```

The 95^th confidence interval for the difference in means is (`r paste(lower, ", ", lower, sep = ""`).  
