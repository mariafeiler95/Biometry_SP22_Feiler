...
cat("The quartiles of the permutations were ", paste(round(quantile(dif), digits = 2), "(", c("0%", "25%", "50%", "75%", "100%"), ")", c(", ", ", ", ", ", ", ", ""), sep = ""), ".", sep ="")

# Get the standard deviation of the differences
cat("The permutations' had an average", paste(round(mean(dif), digits = 2), "±", round(sd(dif), digits = 2)), "difference from the null hypothesis.")
...
cat("The p-value of the original sample is ", p_value, ".", sep = "")
```
...
The standard error of the treatment bootstrap (`r sterr_treat`) is `r ifelse(sterr_treat > sd_treat, "greater than", "less than") ` the standard deviation of the original treatment sample (`r sd_treat`).  
...
The standard error of the control bootstrap (`r sterr_con`) is `r ifelse(sterr_con > sd_con, "greater than", "less than") ` the standard deviation of the original control sample (`r sd_con`).  
...
The standard error of the difference in means is `r sterr_diff`.  
