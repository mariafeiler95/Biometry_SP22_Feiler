...
```
```{r p2q2 ttest, echo = FALSE, comment = NA}
...
```{r water table, echo = FALSE, comment = NA, cache = TRUE}
...
The p_value for the difference in sample variances between the two samples is `r round(p_value, digits = 3)`, and we `r ifelse(p_value < 0.05, "reject the null hypothesis.", "fail to reject the null hypothesis.")`
